...
export default async function Image(props: {
  ...
  return new ImageResponse(
    (
      // 바깥 여백 + 안쪽 패널 = 카드 형태. 다운로드한 이미지는 스토리·리포스트로
      // 혼자 돌아다니는데 가장자리까지 꽉 찬 그림은 배경 사진처럼 보인다.
      <div
        style={{
          width: '100%',
          height: '100%',
          ...
          {card?.gameImage && (
            ...
            <img
              ...
              style={{
                ...
                height: '100%',
                objectFit: 'cover',
                // satori 는 부모 overflow:hidden 으로 절대배치 자식을 다 못 깎는다
                // (모서리에 아트가 삐져나온다) — 자식에도 반경을 직접 준다.
                borderRadius: 26,
              }}
            />
          )}
